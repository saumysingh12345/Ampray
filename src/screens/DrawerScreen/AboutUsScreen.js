...
export default function AboutUsScreen() {
  ...
  useEffect(() => {
    ...
    reference.on('value', Snapshot => {
       setAboutUsText(Snapshot.val().AboutUsText)
            ...
            <View style={styles.shadowContainerStyleForHeader}>
                ...
                <View style={{ flexDirection: "row", flex: 1, }}>
                    ...
                    <View style={{ flex: 6, paddingTop: 5 }}>
                        <Text style={{ color: "white", fontWeight: '900', fontSize: windowWidth * 60 / 1000, }}>About Us</Text>
                    </View>

                </View>
            </View>
            <View style={{padding:10}}>
            <Text style={{ fontSize: windowWidth * 70 / 1000, fontWeight: '800', color: 'black' }}>About Us</Text>
            <Text style={{ fontSize: windowWidth * 40 / 1000, fontWeight: '500', color: 'gray', marginBottom: windowHeight * 60 / 1000 ,paddingHorizontal:10}}>{aboutUsText}</Text>
            </View>
